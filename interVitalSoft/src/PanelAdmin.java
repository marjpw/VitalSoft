...
public class PanelAdmin extends JPanel {
    ...
    public PanelAdmin(MainFrame mainFrame, ServiceManager services, Administrador admin) {
        ...
        btnRegMed.addActionListener(e -> {
            ...
            mainFrame.add(new PanelRegistroMedico(mainFrame, services, admin));
        ...
        btnRegPac.addActionListener(e -> {
            mainFrame.getContentPane().removeAll();
            mainFrame.add(new PanelRegistroPaciente(mainFrame, services, admin));
            mainFrame.revalidate();
            mainFrame.repaint();
        });
        ...
        btnTriaje.addActionListener(e -> {
            mainFrame.getContentPane().removeAll();
            mainFrame.add(new PanelTriaje(mainFrame, services, admin));
            mainFrame.revalidate();
            mainFrame.repaint();
        });
