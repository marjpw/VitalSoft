            ...
            try {
                ...
                switch (op) {
                    case 1:
                        ...
                        Paciente pac = services.getPacienteService().loginPaciente(uP, pP);
                        if (pac != null) {
                            System.out.println("Bienvenido/a " + pac.getNombre());
                            Menu.menuPaciente(pac, services);
                        } else
                    ...
                    case 2:
                        ...
                        Medico med = services.getMedicoService().loginMedico(uM, pM);
                        if (med != null) {
                            System.out.println("Bienvenido Dr/a. " + med.getApellidos());
                            Menu.menuMedico(med, services);
                        } else
                            System.out.println("❌ Credenciales incorrectas.");
                        break;
                    ...
                    case 3:
                        ...
                        Administrador admin = services.getAdministradorService().loginAdmin(uA, pA);

                        if (admin != null) {

                            Menu.mostrarMenuAdministrador(admin, services);
                        } else
