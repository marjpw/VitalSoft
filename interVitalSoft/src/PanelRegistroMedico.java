...
public class PanelRegistroMedico extends PanelFondoImagen {
    ...
    public PanelRegistroMedico(MainFrame mainFrame, GestionClinica gestion, Administrador admin) {
    ...
    private void accionRegistrar() {
        ...
        gestion.registrarMedico(txtNombre.getText(), txtApellido.getText(), txtEspecialidad.getText(), txtDni.getText(),
