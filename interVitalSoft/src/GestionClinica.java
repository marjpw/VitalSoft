...
public class GestionClinica {
    // CAMBIO IMPORTANTE: Ahora son public static y se llaman
    // listaPacientes/listaMedicos
    // para que las tablas puedan leerlos directamente.
    ...
    public GestionClinica() {
        ...
        listaMedicos.add(new Medico("Juan", "Perez", "Cardiologia", "10101010", 80.00, "Lunes, Miercoles",
                "09:00-13:00", "1234"));
        listaMedicos.add(
                new Medico("Maria", "Lopez", "Pediatria", "20202020", 60.00, "Martes, Jueves", "15:00-19:00", "1234"));
        listaMedicos
                .add(new Medico("Carlos", "Ruiz", "Dermatologia", "30303030", 70.00, "Viernes", "10:00-14:00", "1234"));
    }

    // --- LOGIN ---
    public Paciente loginPaciente(String dni, String psw) {
        for (Paciente p : listaPacientes) // Actualizado a listaPacientes
    ...
    public Medico loginMedico(String dni, String psw) {
        for (Medico m : listaMedicos) // Actualizado a listaMedicos
    ...
    public void registrarPaciente(String nombre, String apellido, String dni, String cel, LocalDate nac,
        ...
        listaPacientes.add(nuevo); // Actualizado a listaPacientes
    ...
    public void registrarMedico(String nombre, String apellido, String esp, String dni, double precio, String dias,
        ...
        listaMedicos.add(new Medico(nombre, apellido, esp, dni, precio, dias, horas, psw)); // Actualizado a
                                                                                            // listaMedicos
    ...
    public void eliminarMedico(int idMedico) {
        ...
        listaMedicos.removeIf(m -> m.getId() == idMedico); // Actualizado
    ...
    public List<Medico> obtenerMedicosPorEspecialidad(String especialidad) {
        return listaMedicos.stream().filter(m -> m.getEspecialidad().equalsIgnoreCase(especialidad))
