...
public class PanelTriaje extends PanelFondoImagen {
    ...
    public PanelTriaje(MainFrame mainFrame, GestionClinica gestion, Administrador admin) {
    ...
    private void cargarCitasPendientes() {
        ...
        List<Cita> pendientes = gestion.getCitasPendientesTriaje();
    ...
    private void accionRegistrar() {
        ...
        try {
            ...
            gestion.registrarTriaje(citaSel.getId(), peso, talla, temp, presion);
