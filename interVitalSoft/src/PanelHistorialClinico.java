...
public class PanelHistorialClinico extends JPanel {
    ...
    public PanelHistorialClinico(MainFrame mainFrame, ServiceManager services, Medico medicoActual, Paciente paciente) {
        ...
        btnRegresar.addActionListener(e -> mainFrame.mostrarPanelSeleccionPaciente(medicoActual));
    ...
    // Renderizadores de botón (igual que antes)
    ...
    private void verDetalles(int fila) {
        ...
        if (c != null) {
            mainFrame.mostrarPanelDetalleLectura(medicoActual, c);
        }
    }
