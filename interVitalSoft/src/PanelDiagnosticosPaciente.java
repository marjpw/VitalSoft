...
public class PanelDiagnosticosPaciente extends JPanel {
    ...
    public PanelDiagnosticosPaciente(MainFrame mainFrame, ServiceManager services, Paciente paciente) {
        ...
        JLabel lblTitulo = new JLabel("Historial de Citas", SwingConstants.CENTER);
        ...
        // --- TABLA ---
        String[] columnas = { "ID", "Fecha", "Médico", "Especialidad", "Motivo", "Acción" };
        ...
        for (Cita c : historial) {
            ...
            if (c.getEstado() == EstadoCita.ATENDIDO) {
                modelo.addRow(new Object[] {
                        c.getId(),
                        c.getFecha(),
                        c.getMedico().getNombre() + " " + c.getMedico().getApellidos(),
    ...
    class ButtonRenderer extends JButton implements TableCellRenderer {
        public ButtonRenderer() {
            setOpaque(true);
            setBackground(new Color(93, 173, 226)); // Azul/Verde suave
    ...
    private void verDetalles(int fila) {
        ...
        if (c != null) {
            mainFrame.mostrarPanelDetalleDiagnostico(c); // Navegación nueva
        }
    }
