...
public class MainFrame extends JFrame {
    ...
    private ServiceManager services; // Referencia a la lógica
    private Administrador adminLogueado;

    public MainFrame() {
        services = new ServiceManager(); // Inicializamos el backend
    ...
    public void mostrarPanelAdmin(Administrador admin) {
        ...
        PanelAdmin panelAdmin = new PanelAdmin(this, services, admin);
        add(panelAdmin);
        revalidate();
        repaint();
    }
    ...
    public void mostrarPanelPaciente(Paciente paciente) {
        ...
        PanelPaciente panel = new PanelPaciente(this, services, paciente);
