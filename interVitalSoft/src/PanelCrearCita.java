...
public class PanelCrearCita extends PanelFondoImagen {
    ...
    public PanelCrearCita(MainFrame mainFrame, GestionClinica gestion, Paciente paciente) {
        ...
        btnRegresar.addActionListener(e -> {
            ...
            mainFrame.add(new PanelPaciente(mainFrame, gestion, paciente));
    ...
    private void cargarEspecialidades() {
        ...
        for (String esp : gestion.obtenerEspecialidades())
    ...
    private void cargarMedicos(String especialidad) {
        ...
        if (especialidad == null)
            return;
        List<Medico> medicos = gestion.obtenerMedicosPorEspecialidad(especialidad);
    ...
    private void accionCrearCita() {
        ...
        gestion.crearCita(paciente, medico, fechaCita, motivo);
